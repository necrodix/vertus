...
const t = {
  es: {
    ...
    'hub.eyebrow':'VIRTUS ADVISORY PARTNERS','hub.title':'Tu HUB de Ingeniería Financiera','hub.lead':'Financiamiento + Tesorería + Riesgos + Consultoría integrados en una sola estrategia.','hub.body':'No vendemos productos. Diseñamos estructuras financieras y acompañamos su ejecución.','hub.cta':'Conoce cómo trabajamos','hub.step1':'Analizamos','hub.step1body':'Balance, flujo, deuda y exposición.','hub.step2':'Estructuramos','hub.step2body':'La estructura financiera adecuada.','hub.step3':'Negociamos','hub.step3body':'Con instituciones y aliados especializados.','hub.step4':'Implementamos','hub.step4body':'Con seguimiento y ajustes continuos.',
    'about.eyebrow':'QUIÉNES SOMOS','about.title':'Experiencia financiera. Visión integral. Ejecución estratégica.','about.statement':'Nace de la integración estratégica de más de 25 años de experiencia en los sectores financiero, bancario y bursátil.','about.body':'Integramos financiamiento, tesorería, gestión de riesgos y consultoría empresarial dentro de una misma estrategia de negocio.','about.mission':'MISIÓN','about.missionTitle':'Acompañamos decisiones financieras con precisión y oportunidad.','about.missionBody':'Acompañar a cada cliente con asesoría oportuna y herramientas de alta ingeniería financiera para afrontar incertidumbre, ejecutar decisiones y fortalecer su dirección financiera.','about.vision':'VISIÓN','about.visionTitle':'Ser el HUB de referencia en Ingeniería Financiera y Tesorería Corporativa.','about.visionBody':'Ser el HUB de Ingeniería Financiera y Tesorería Corporativa de referencia en la región, combinando precisión técnica, agilidad de ejecución y protección del capital.','about.valuesEyebrow':'NUESTROS VALORES','about.valuesTitle':'Cuatro pilares que orientan cada decisión.','about.v1':'Templanza','about.v1Tag':'Gestión prudente del riesgo','about.v1Body':'Disciplina para proteger márgenes y estructurar coberturas y financiamiento.','about.v2':'Fortaleza','about.v2Tag':'Resiliencia financiera y ejecución','about.v2Body':'Rigor técnico para acompañar decisiones complejas y negociaciones financieras.','about.v3':'Prudencia / Sabiduría','about.v3Tag':'Criterio técnico y analítico','about.v3Body':'Diagnóstico preciso sustentado en experiencia bancaria, cambiaria y fiscal.','about.v4':'Justicia','about.v4Tag':'Equidad e imparcialidad fiduciaria','about.v4Body':'Relaciones de largo plazo basadas en transparencia, equidad y cumplimiento.',
  ...
  en: {
    ...
    'hub.eyebrow':'VIRTUS ADVISORY PARTNERS','hub.title':'Your Financial Engineering HUB','hub.lead':'Financing + Treasury + Risk + Consulting integrated into one strategy.','hub.body':'We do not sell products. We design financial structures and support execution.','hub.cta':'See how we work','hub.step1':'Analyze','hub.step1body':'Balance sheet, cash flow, debt and exposure.','hub.step2':'Structure','hub.step2body':'The right financial structure.','hub.step3':'Negotiate','hub.step3body':'With institutions and specialized partners.','hub.step4':'Implement','hub.step4body':'With ongoing monitoring and adjustments.',
    'about.eyebrow':'ABOUT US','about.title':'Financial experience. Integrated vision. Strategic execution.','about.statement':'Born from the strategic integration of more than 25 years of experience in the financial, banking and securities sectors.','about.body':'We integrate financing, treasury, risk management and business consulting within a single business strategy.','about.mission':'MISSION','about.missionTitle':'We support financial decisions with precision and timeliness.','about.missionBody':'To support every client with timely advice and high-level financial engineering tools to navigate uncertainty, execute decisions and strengthen financial leadership.','about.vision':'VISION','about.visionTitle':'To become the regional benchmark for Financial Engineering and Corporate Treasury.','about.visionBody':'To be the leading Financial Engineering and Corporate Treasury HUB in the region, combining technical precision, execution agility and capital protection.','about.valuesEyebrow':'OUR VALUES','about.valuesTitle':'Four pillars that guide every decision.','about.v1':'Temperance','about.v1Tag':'Prudent risk management','about.v1Body':'Discipline to protect margins and structure hedging and financing.','about.v2':'Fortitude','about.v2Tag':'Financial resilience and execution','about.v2Body':'Technical rigor to support complex decisions and financial negotiations.','about.v3':'Prudence / Wisdom','about.v3Tag':'Technical and analytical judgment','about.v3Body':'Precise diagnosis grounded in banking, foreign exchange and tax experience.','about.v4':'Justice','about.v4Tag':'Fiduciary fairness and impartiality','about.v4Body':'Long-term relationships based on transparency, fairness and compliance.',
...
function setLanguage(lang){
  ...
  languageSwitcher?.setAttribute('aria-label', lang === 'es' ? 'Selector de idioma' : 'Language selector');
